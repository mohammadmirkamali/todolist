...
const Items: React.FC<ItemsType> = ({ title, count, text, img }) => (
  <div className="center flex-col w-[250px]">
...
const Info: React.FC = () => (
  <div className="center m-[2rem] mt-[6rem]">
    <div className="h-[80rem] md:h-[27rem] w-[280px] flex-col md:flex-row relative md:w-[90vw] justify-around max-w-[1200px] rounded-[8px] center">
